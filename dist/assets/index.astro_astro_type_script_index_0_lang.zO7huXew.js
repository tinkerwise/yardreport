import{f as M,$ as v,r as I,M as w,S as L,e as o,P as S,c as T,a as H,b as P,d as D,g as A,t as k,p as R,l as x,s as j,O as E}from"./utils.C8LDhMvw.js";import{f as N,g as O}from"./weather.CoB1xdc0.js";import{f as B}from"./scores.CZWqkHIa.js";function b(e,t){const a=e.note?`<span class="roster-badge roster-badge--replacement" title="${o(e.note)}">Replacement</span>`:"",s=e.playerId??x(t,e.name),n=s?`<a class="roster-name" href="${j(s)}" target="_blank" rel="noopener">${o(e.name)}</a>`:`<span class="roster-name" data-name-lookup="${o(e.name)}">${o(e.name)}</span>`;return`<div class="roster-item">
