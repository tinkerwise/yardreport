...
export const FALLBACK_WALKUP_SONGS = {
  // ── Active roster (sourced from mlb.com/orioles/ballpark/music, June 2026) ──
  677942: ['https://open.spotify.com/track/1E6bzmruhqnQDzq78o7Qq1'], // Blaze Alexander – Pump It Up (Joe Budden)
  624413: ['https://open.spotify.com/track/31DvHUCSioX0JD7B4kZMJ9'], // Pete Alonso – Money for Nothing (Dire Straits)
  ...
  // songs unknown – Keegan Akin (669211), Sam Huff (669087), Trey Gibson (694346), Andrew Kittredge (552640), Brandon Young (687064)
